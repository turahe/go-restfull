...
import (
	...
	// _ "github.com/turahe/go-restfull/docs" // Temporarily disabled; generated by swag
)
...
func customErrorHandler(c *fiber.Ctx, err error) error {
	...
	// Disabled logging here to avoid any chance of secondary panics inside the error handler
